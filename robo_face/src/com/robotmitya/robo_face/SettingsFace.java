...
class SettingsFace {
    ...
    static ArrayList<CharSequence> getCameraModeEntries(final CameraSizesSet cameraSizesSet, final Context context) {
        ArrayList<CharSequence> entries = new ArrayList<>();
    ...
    static ArrayList<CharSequence> getCameraModeValues(final CameraSizesSet cameraSizesSet) {
        ArrayList<CharSequence> values = new ArrayList<>();
